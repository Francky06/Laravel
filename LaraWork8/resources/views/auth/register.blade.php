...
@section('content')
<h1 class="text-3xl text-green-500 mb-6 mt-6 text-center">Completez vos informations</h1>
<form method="POST" action="{{ route('register') }}" class="w-full max-w-sm mx-auto rounded-lg border shadow-md p-5 mb-5">
    ...
    <p for="role-select" class="font-semibold text-gray-700 mt-4 text-center">Fonctions</p>
