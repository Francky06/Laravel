...
@section('content')
  <h1 class="text-3xl text-green-500 text-center mb-5 mt-5">Tableau de bord</h1>
  <h2 class="text-2xl text-green-500 text-center mb-5 mt-5">Hello {{ auth()->user()->name}}</h2>
  <div class="flex flex-col md:flex-row text-center">
  <section class="text-gray-700 w-full w-1/3 mr-5">
  <h2 class="text-xl my-2 mb-5"><svg class="w-6 h-6 inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
